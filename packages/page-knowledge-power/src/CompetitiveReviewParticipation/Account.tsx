...
import { DeriveDemocracyLock, DeriveBalancesAll} from '@polkadot/api-derive/types';
import { AccountStatistics  } from '@polkadot/types/interfaces';
...
import { AddressSmall,CryptoType, Tags,  Forget, Icon } from '@polkadot/react-components';
...
function Account ({account: { address, meta }, className = '', delegation, filter, isFavorite, proxy, setBalance, toggleFavorite }: Props): React.ReactElement<Props> | null | any{
  ...
  const { tags } = useAccountInfo(address);
