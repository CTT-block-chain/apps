  ...
  try {
    ...
    if (storedItems) {
      ...
      return items.map(item => ({
        info: "local",
        text: t<string>("rpc.custom.entry", "Custom (custom, {{WS_URL}})", {
          ns: "apps-config",
          replace: { WS_URL: item }
        }),
        value: item
...
function createDev(t: TFunction): LinkOption[] {
  return [
    ...
    },
    {
      dnslink: "ctt",
      info: "ctt",
      text: t<string>("rpc.local", "Local Node (Own, 39.106.116.92:9944)", { ns: "apps-config" }),
...
function createTestNetworks(t: TFunction): LinkOption[] {
  return [
    ...
    },
    {
      info: "rococoDarwinia",
      isChild: true,
      text: t<string>("rpc.rococo.darwinia", "Darwinia PC1 (Darwinia Testpara, hosted by Darwinia Network)", {
        ns: "apps-config"
      }),
    ...
    },
    {
      info: "rococoPlasm",
      isChild: true,
      text: t<string>("rpc.rococo.plasm", "Plasm PC1 (Plasm Testpara, hosted by Stake Technologies)", {
        ns: "apps-config"
      }),
    ...
    },
    {
      ...
      isChild: true,
      text: t<string>("rpc.rococo.robonomics", "Robonomics PC1 (Robonomics Testpara, hosted by Airalab)", {
        ns: "apps-config"
      }),
    ...
    },
    {
      info: "rococoLaminar",
      isChild: true,
      text: t<string>("rpc.rococo.laminar", "Turbulence PC1 (Laminar Testpara, hosted by Laminar)", {
        ns: "apps-config"
      }),
    ...
    {
      info: "edgeware",
      text: t<string>("rpc.beresheet", "Beresheet (Edgeware Testnet, hosted by Commonwealth Labs)", {
        ns: "apps-config"
      }),
    ...
    {
      info: "crust",
      text: t<string>("rpc.crust.network", "Crust Maxwell CC2 (Crust Testnet, hosted by Crust Network)", {
        ns: "apps-config"
      }),
